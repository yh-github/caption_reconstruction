...
if __name__ == "__main__":
    ...
    config = load_config('/home/yoavh/code/research/caption_reconstruction/config/qa/wild_video1.yaml')
    ...
    def gen_text_prompt(qa_info:list[QAData]):
    ...
    with diskcache.Cache(directory=config['paths']['disk_cache']) as llm_cache:
        ...
        for va in wild_captions:
            ...
            llm_input = gen_content_prompt(
                vl=link_by_id[va.video_id],

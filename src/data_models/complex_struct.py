...
class VideoSegment(BaseModel):
    ...
    objects: list[str] = Field(default_factory=list, description="Solid items like furniture, vehicles, tools, etc.")
    stuff: list[str] = Field(default_factory=list, description="Materials/substances like water, sand, smoke, etc.")
